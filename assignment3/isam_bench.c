...
#define maxSleutels (30000)

static
char    sleutels[maxSleutels + 10000][20];
...
/* De code wordt gemiddeld met 3.5 opgehoogd, dus er kunnen max zo'n
   2800 sleutels worden aangemaakt. Ze zijn overigens niet 100%
   gegarandeerd uniek. */
...
randomNieuwRecord (isamPtr ip)
{
    ...
    /* Garandeer dat de nieuwe sleutel nog niet/niet meer
       in het bestand zit */
    do
    {
